...
public class WordCount {
    // nc -l 9877
    // flink run -c com.flink.learn.example.entry.WordCount
    // /Users/eminem/workspace/flink/flink-learn/flink-example/target/flink-example-1.13.0.jar
        ...
        DataStream<WordWithCount> windowCounts =
                text.flatMap(
                                new RichFlatMapFunction<String, WordWithCount>() {
                                    ...
                                    @Override
                                    public void flatMap(
                                            String s, Collector<WordWithCount> collector)
                                            throws Exception {
                                        inputcount += 1;
                                    ...
                                    public void open(Configuration parameters) throws Exception {
                                        ...
                                        getRuntimeContext()
                                                .getMetricGroup()
                                                .gauge("noGroupGauge-inputcount", () -> inputcount);
                                        getRuntimeContext()
                                                .getMetricGroup()
                                                .gauge("noGroupGauge-outcount", () -> outcount);
                                        ...
                                        getRuntimeContext()
                                                .getMetricGroup()
                                                .addGroup("group-key", "group-value")
                                                .gauge("GroupGauge-inputcount", () -> inputcount);
                                        getRuntimeContext()
                                                .getMetricGroup()
                                                .addGroup("group-key", "group-value")
                                                .gauge("GroupGauge-outcount", () -> outcount);
                                    }
                                })

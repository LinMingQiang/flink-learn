...
public class VipHyperLogLog implements ICardinality, Serializable {
     ...
     */
    public VipHyperLogLog(int log2m) {
     ...
     */
    public void addAll(VipHyperLogLog other) throws CardinalityMergeException {
    ...
    public ICardinality merge(ICardinality... estimators) throws CardinalityMergeException {
        VipHyperLogLog merged = new VipHyperLogLog(log2m, new RegisterSet(this.registerSet.count));
        merged.addAll(this);
    ...
    private static class SerializationHolder implements Externalizable {
        ...
        VipHyperLogLog hyperLogLogHolder;

        public SerializationHolder(VipHyperLogLog hyperLogLogHolder) {
    ...
    public static class Builder implements IBuilder<ICardinality>, Serializable {
        ...
        @Override
        public VipHyperLogLog build() {
            return new VipHyperLogLog(rsd);
        }
        ...
        public static VipHyperLogLog build(byte[] bytes) throws IOException {

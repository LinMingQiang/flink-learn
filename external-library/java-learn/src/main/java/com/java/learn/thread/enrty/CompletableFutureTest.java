...
public class CompletableFutureTest {
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        // completablefuture.whenCompleteAsync((v ,e) ->{
        ...
        // completablefuture.thenApplyAsync((v) -> ">> " + v);
        //
    ...
    public static void allof() throws ExecutionException, InterruptedException {
        ...
        CompletableFuture<Void> re =
                CompletableFuture.allOf(completablefuture, completablefuture2, completablefuture3);

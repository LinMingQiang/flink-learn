...
public class RestfulUrlParameter {
    ...
    public static String FLINK_JOBS_JID_INFO(String yarnPre, String appid, String jid) {
        return yarnPre + "/" + appid + FLINK_STREAM_JOBS + jid;
    }

    public static String FLINK_JOBS_JID_VERTICES_INFO(
            String yarnPre, String appid, String jid, String verticesId) {
        return yarnPre + "/" + appid + FLINK_STREAM_JOBS + jid + FLINK_VERTICES + "/" + verticesId;
    }
}

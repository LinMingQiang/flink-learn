...
public class MySqlDynamicTableSink implements DynamicTableSink {
    ...
    public MySqlDynamicTableSink(DataType type, ReadableConfig options, DataType shcema) {
        this.type = type;
    ...
    public SinkRuntimeProvider getSinkRuntimeProvider(Context context) {
        ...
        return SinkFunctionProvider.of(new MySqlTableRichSinkFunction(converter, options, shcema));
    }

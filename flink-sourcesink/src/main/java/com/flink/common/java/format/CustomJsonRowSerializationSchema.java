 ...
 *
 * <p>Result <code>byte[]</code> messages can be deserialized using {@link CustomJsonRowDeserializationSchema}.
 */
@PublicEvolving
public class CustomJsonRowSerializationSchema implements SerializationSchema<Row> {
	 ...
	 */
	@Deprecated
	public CustomJsonRowSerializationSchema(TypeInformation<Row> typeInfo) {
	...
	/**
	 * Builder for {@link CustomJsonRowSerializationSchema}.
	 */
	@PublicEvolving
	public static class Builder {
		...
		public CustomJsonRowSerializationSchema build() {
			return new CustomJsonRowSerializationSchema(typeInfo);
		}
	}
	...
	public boolean equals(Object o) {
		...
		final CustomJsonRowSerializationSchema that = (CustomJsonRowSerializationSchema) o;
	...
	private JsonNode convertLocalDateTime(ObjectMapper mapper, JsonNode reuse, Object object) {
		return mapper.getNodeFactory()
			.textNode(CustomTimeFormats.RFC3339_TIMESTAMP_FORMAT.format((LocalDateTime) object));
	}
	...
	private JsonNode convertLocalTime(ObjectMapper mapper, JsonNode reuse, Object object) {
		...
		return nodeFactory.textNode(CustomTimeFormats.RFC3339_TIME_FORMAT.format((LocalTime) object));
	}

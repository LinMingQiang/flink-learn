...
public class CustomJsonRowDeserializationSchema implements DeserializationSchema<Row> {
	...
	private CustomJsonRowDeserializationSchema(
	...
	/**
	 * Builder for {@link CustomJsonRowDeserializationSchema}.
	 */
	public static class Builder {
		...
		public CustomJsonRowDeserializationSchema build() {
			return new CustomJsonRowDeserializationSchema(typeInfo, failOnMissingField);
		}
	}
	...
	public boolean equals(Object o) {
		...
		final CustomJsonRowDeserializationSchema that = (CustomJsonRowDeserializationSchema) o;
	...
	/**
	 * 就是DeserializationRuntimeConverter 接口的实现
	 * @return
	 */
	...
	private LocalDateTime convertToLocalDateTime(ObjectMapper mapper, JsonNode jsonNode) {
		...
		TemporalAccessor parsedTimestamp = CustomTimeFormats.RFC3339_TIMESTAMP_FORMAT.parse(jsonNode.asText());
	...
	private LocalTime convertToLocalTime(ObjectMapper mapper, JsonNode jsonNode) {
		...
		TemporalAccessor parsedTime = CustomTimeFormats.RFC3339_TIME_FORMAT.parse(jsonNode.asText());

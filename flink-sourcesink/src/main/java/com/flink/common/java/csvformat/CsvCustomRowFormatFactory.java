package com.flink.common.java.csvformat;
...
import com.flink.common.java.csvformat.CsvCustomRowDeserializationSchema.Builder;
...
public final class CsvCustomRowFormatFactory extends TableFormatFactoryBase<Row> implements SerializationSchemaFactory<Row>, DeserializationSchemaFactory<Row> {

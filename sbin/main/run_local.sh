...
cd /Users/eminem/programe/flink-1.9.1/
echo "start ........"
./bin/flink run  \
-s file:///Users/eminem/workspace/flink/flink-learn/savepoint/savepoint-c4fb21-d0e5d7045b40 \
-c com.flink.common.entry.SocketWordcountTest /Users/eminem/workspace/flink/flink-learn/flink-demo/target/flink-demo-1.0.0.jar
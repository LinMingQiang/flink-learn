...
echo "start ........"
flink run-application -Dexecution.runtime-mode=STREAMING --detached -c com.flink.learn.entry.FlinkCoreOperatorEntry /Users/eminem/workspace/flink/flink-learn/dist/lib/flink-core-1.14.2.jar "runWordCount"

...
echo "start ........"
flink run-application -Dexecution.runtime-mode=STREAMING --detached -c com.flink.learn.entry.FlinkCoreOperatorEntry /Users/eminem/workspace/flink/flink-learn/dist/lib/flink-core-1.13.0.jar "runWordCount"

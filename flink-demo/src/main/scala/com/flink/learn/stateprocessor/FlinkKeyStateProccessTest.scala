...
import com.flink.learn.reader.{WordCounKeyreader, WordCounTuple2Keyreader}
import com.flink.learn.trans.{AccountKeyedStateBootstrapFunction, AccountTuple2KeyedStateBootstrapFunction}
...
object FlinkKeyStateProccessTest {
  ...
  val srcCkpPath = ckpPath + "/SocketScalaWordcountTest/202007021707/d2aab72cbbe53e061fc984ac40173ede/chk-3"

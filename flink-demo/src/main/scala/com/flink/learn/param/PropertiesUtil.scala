...
object PropertiesUtil {
  ...
  lazy val BUYER_INDEX = getProperties("es.index1")
  lazy val SELLER_INDEX = getProperties("es.index2") // appid
  lazy val INDEX_TYPE = "indextype"

...
public class FlinkStreamDAUEntry {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<KafkaManager.KafkaTopicOffsetTimeUidMsg> uid1T = null;
        uid1T.keyBy((KeySelector<KafkaManager.KafkaTopicOffsetTimeUidMsg, String>) value -> value.msg()) // 按key分配
                ...
                .process(new ProcessWindowFunction<KafkaManager.KafkaTopicOffsetTimeUidMsg,
                    ...
                    public void process(String groupKey,
                                        Context context,
                                        Iterable<KafkaManager.KafkaTopicOffsetTimeUidMsg> elements,
                        ...
                        for (KafkaManager.KafkaTopicOffsetTimeUidMsg element : elements) {

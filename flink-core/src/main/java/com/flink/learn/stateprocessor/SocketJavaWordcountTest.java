...
public class SocketJavaWordcountTest {
    public static void main(String[] args) throws Exception {
        FlinkLearnPropertiesUtil.init(
                EnvironmentalKey.LOCAL_PROPERTIES_PATH(), "SocketJavaPoJoWordcountTest");
        ...
        RocksDBStateBackend rocksDBStateBackend =
                new RocksDBStateBackend(FlinkLearnPropertiesUtil.CHECKPOINT_PATH(), true);
        ...
        source.map(
                ...
                .flatMap(
                        new RichFlatMapFunction<WordCountPoJo, WordCountPoJo>() {
                            ValueState<WordCountPoJo> lastState = null;

                            @Override
                            public void flatMap(WordCountPoJo value, Collector<WordCountPoJo> out)
                                    throws Exception {
                            ...
                            public void open(Configuration parameters) throws Exception {
                                ...
                                ValueStateDescriptor desc =
                                        new ValueStateDescriptor<WordCountPoJo>(

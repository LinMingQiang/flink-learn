...
public class FlinkEvnBuilder {
    ...
    public static void initEnv(String confPath) throws IOException {
        ...
        streamEnv =
                FlinkEvnBuilder.buildStreamingEnv(
                        ...
                        0L);
        tableEnv = FlinkEvnBuilder.buildStreamTableEnv(streamEnv, Duration.ofDays(1));
    }
    ...
    public static StreamExecutionEnvironment buildStreamingEnv(
            ParameterTool parameters, String checkpointPath, Long checkPointInterval) {
        ...
        if (checkPointInterval > 0L) {
            ...
            env.getCheckpointConfig()
                    .setMinPauseBetweenCheckpoints(checkPointInterval); // ; 两个chk最小间隔
        }
        ...
        // ：这个配置现在无效了，需要在richfunc里面设置ttlconf或者sql的ttl
    ...
    public static StreamTableEnvironment buildStreamTableEnv(
            StreamExecutionEnvironment streamEnv, Duration stateTTL) throws IOException {

...
public class FlinkSQLEntry {
    ...
    public static void main(String[] args) throws Exception {
        ...
        StreamTableEnvironment tableEnv =
                FlinkEvnBuilder.buildStreamTableEnv(streamEnv, Duration.ofHours(1L));
        ...
        tableEnv.createTemporaryView(
                "test3", tableEnv.sqlQuery("select msg,rowtime from test group by msg,rowtime"));
        //        tableEnv.createTemporaryView("test3", tableEnv.sqlQuery("select CONCAT(msg ,
        // '-hai') as msg,rowtime from test where msg is not null"));
        ...
        r.print();
        tableEnv.createTemporaryView("test5", r, $("msg"), $("rowtime").rowtime());
        String sql5 =
                "select "
                        + "msg,"
                        + "count(1) cnt"
